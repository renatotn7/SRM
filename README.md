...
O mesmo conteúdo abaixo(sem as marcacoes markdown) pode ser visto em [arquivo de criacao](blob/main/resources/db.migration/v1__create_tables.sql), [arquivo de inserts](blob/main/resources/db.migration/v2__inserts_padrao.sql)
